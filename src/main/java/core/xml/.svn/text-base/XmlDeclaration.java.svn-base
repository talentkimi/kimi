...
/**
 * An XML Declaration (only has attributes).
 */
public class XmlDeclaration implements Xml {
	...
	public void setName(String name) {
		throw new XmlException("A declaration has no name");
	}
	...
	public void setValue(Object value) {
		throw new XmlException("A declaration has no value");
	}
	...
	public void removeChildren() {
		throw new XmlException("A declaration has no children");
	}
