...
/**
 * An XML Attribute (only has a value).
 */
public class XmlAttribute implements Xml {
	...
	public XmlAttribute(String name, Object value) {
		this(name);
		setValue(parseValue(value.toString()));
	}
	...
	public Xml getChild(int index) {
		throw new XmlException("An attribute has no children");
	}
	...
	public void removeAttributes() {
		throw new XmlException("An attribute has no attributes");
	}
