...
/**
 * An XML Comment (only has a value).
 */
public class XmlComment implements Xml {
	...
	public void setName(String name) {
		throw new XmlException("A comment has no name");
	}
	 ...
	 */
	public XmlComment(Object value) {
		setValue(value);
	}
	...
	public void removeChildren() {
		throw new XmlException("A comment has no children");
	}
	...
	public void removeAttributes() {
		throw new XmlException("A comment has no attributes");
	}
