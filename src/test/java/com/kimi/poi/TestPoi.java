...
import excel.model.User;
import excel.poi.util.ExcelTemplate;
import excel.poi.util.ExcelUtil;
...
public class TestPoi {
	...
	public void test01() {
		...
		et.insertSer();
		et.writeToFile("c:/test/poi/test01.xls");
	}
	...
	public void testObj2Xls() {
		...
		ExcelUtil.getInstance().exportObj2ExcelByTemplate(new HashMap<String,String>(),"/excel/user.xls","c:/test/poi/tus.xls", users, User.class, true);
	}
	...
	public void testObj2Xls2() {
		...
		ExcelUtil.getInstance().exportObj2Excel("d:/test/poi/ss1.xls",stus, Student.class, false);
	}
	...
	public void testRead01() {
		List<Object> stus = ExcelUtil.getInstance().readExcel2ObjsByPath("d:/test/poi/ss1.xls",Student.class);
		for(Object obj:stus) {
	...
	public void testRead02() {
		List<Object> stus = ExcelUtil.getInstance().readExcel2ObjsByPath("d:/test/poi/tus.xls",User.class,1,2);
		for(Object obj:stus) {
			User stu = (User)obj;
			System.out.println(stu);
		}
